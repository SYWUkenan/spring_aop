...
public class LogAspect3 {
    ...
    public void before(JoinPoint joinPoint,Logger logger){
        ...
        System.out.println("前置通知"+ name+"方法运行了，参数是:" + Arrays.asList(args)+",注解信息:"+logger.name());
    }
...
//    }
    ...
    public Object arroud(ProceedingJoinPoint joinPoint){
        ...
        Object returnValue="";
        try {
            System.out.println("环绕前置通知"+ name+"方法运行了，参数是:" + Arrays.asList(args));
            returnValue = joinPoint.proceed();

            System.out.println("环绕后置通知"+ name+"方法运行了，参数是:" + Arrays.asList(args));
